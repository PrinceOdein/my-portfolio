  ...
  return (
    <div class="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
      <div class="bg-white dark:bg-gray-900 rounded-lg max-w-md w-full p-6 relative">
        <button onClick={onClose} class="absolute top-2 right-2 text-gray-400 hover:text-red-500 text-xl">&times;</button>
        ...
        <a href={project.link} class="mt-4 inline-block text-blue-600 hover:underline" target="_blank">Visit Project ↗</a>
      </div>
    </div>
  );
}
